    ...
    return (
        <div className={styles.user_container}>
            <div className={styles.data}>
                <img className={styles.pfp} src="https://www.gravatar.com/avatar/00000000000000000000000000000000?d=identicon&f=y" />
            ...
            <div className={styles.icons}>
                <button className={styles.logout} onClick={signOut}>
                    <FontAwesomeIcon style={{ height: "25px", color: "#aaa" }} icon={faArrowRightFromBracket} />
                </button>
                <Link href="/profile">
                    <FontAwesomeIcon style={{ height: "25px", color: "#aaa" }} icon={faGear} />
                </Link>
            </div>
        </div >
    )
